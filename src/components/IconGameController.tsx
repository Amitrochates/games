...
export const IconGameController: React.FC<ControllerProps> = ({ controllerCount, setControllerCount}) => {
  ...
  if(controllerStates){
    return (
      <div onClick={handleDeActivate} className={"text-green-600 hover:text-green-200 mx-2"}> 
        <svg
          viewBox="0 0 512 512"
          fill="currentColor"
          height="3em"
    ...
    return (
      <div onClick={handleActivate} className={" text-slate-300 hover:text-green-200 mx-2"}> 
        <svg
          viewBox="0 0 512 512"
          fill="currentColor"
          height="3em"
